-- Supabase Cleanup and Setup Script
...
DROP TYPE IF EXISTS unit_system CASCADE;

-- Drop existing functions (if they exist)
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS calculate_member_days() CASCADE;
DROP FUNCTION IF EXISTS update_total_counts() CASCADE;
...
-- Create trigger for member days calculation
